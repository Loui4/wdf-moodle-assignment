 <?php
    ...
    class core_course_renderer extends plugin_renderer_base
    {
         ...
         * @return string
         */
        private function course_section_add_cm_control_nonajax(
            $course,
            $section,
            $sectionreturn = null,
        ...
        public function course_section_cm_completion($course, &$completioninfo, cm_info $mod, $displayoptions = array())
        {
            ...
            debugging(
                __FUNCTION__ . ' is deprecated and is being replaced by the activity_information output component.',
                DEBUG_DEVELOPER
            );
        ...
        public function frontpage_combo_list()
        {
            ...
            $chelper = new coursecat_helper();
            $chelper->set_subcat_depth($CFG->maxcategorydepth)->set_categories_display_options(array(
                'limit' => $CFG->coursesperpage,
                'viewmoreurl' => new moodle_url(
                    '/course/index.php',
        ...
        public function frontpage_categories_list()
        {
            ...
            $chelper = new coursecat_helper();
            $chelper->set_subcat_depth($CFG->maxcategorydepth)->set_show_courses(self::COURSECAT_SHOW_COURSES_COUNT)->set_categories_display_options(array(
                'limit' => $CFG->coursesperpage,
                'viewmoreurl' => new moodle_url(
                    '/course/index.php',
                    array('browse' => 'categories', 'page' => 1)
        ...
        public function sendingbackupinfo($backupfile)
        {
            ...
            $html = html_writer::tag(
                'div',
                get_string('sendingsize', 'hub', $sizeinfo),
        ...
        public function hubinfo($hubinfo)
        {
            ...
            $hubdescription = html_writer::tag(
                'div',
                $screenshothtml,
            ...
            $hubdescription .= html_writer::tag(
                ...
                $hubinfo['name'],
                array(
                    'class' => 'hublink', 'href' => $hubinfo['url'],
            ...
            $hubdescription .= html_writer::tag(
                'div',
                format_text($hubinfo['description'], FORMAT_PLAIN),
