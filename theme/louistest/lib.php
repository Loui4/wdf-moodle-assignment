...
function theme_louistest_get_main_scss_content($theme)
{
    global $CFG;
    ...
    $pre = file_get_contents($CFG->dirroot . '/theme/louistest/scss/pre.scss');
    // Post CSS - this is loaded AFTER the main scss but before the extra scss from the setting.                                    
    $post = file_get_contents($CFG->dirroot . '/theme/louistest/scss/post.scss');
