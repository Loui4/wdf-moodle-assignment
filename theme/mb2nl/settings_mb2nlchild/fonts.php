...
$setting = new admin_setting_configmb2start('theme_mb2nlchild/startnfonts', get_string('nfonts','theme_mb2nl'));
$temp->add($setting);
...
$setting = new admin_setting_configmb2start('theme_mb2nlchild/startgfonts', get_string('gfonts','theme_mb2nl'));
$temp->add($setting);
...
$setting = new admin_setting_configmb2start('theme_mb2nlchild/startcfonts', get_string('cfont','theme_mb2nl'));
$temp->add($setting);
