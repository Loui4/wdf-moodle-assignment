...
$setting = new admin_setting_configmb2start('theme_mb2nlchild/startfgeneral', get_string('global','theme_mb2nl'));
$temp->add($setting);
...
$setting = new admin_setting_configmb2start('theme_mb2nlchild/startfheadings', get_string('headings','theme_mb2nl'));
$temp->add($setting);
...
$setting = new admin_setting_configmb2start('theme_mb2nlchild/startfmenu', get_string('menu','theme_mb2nl'));
$setting->set_updatedcallback('theme_reset_all_caches');
$temp->add($setting);
...
$setting = new admin_setting_configmb2start('theme_mb2nlchild/startfddmenu', get_string('ddmenu','theme_mb2nl'));
$setting->set_updatedcallback('theme_reset_all_caches');
$temp->add($setting);
