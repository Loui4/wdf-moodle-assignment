...
$setting = new admin_setting_configmb2start('theme_mb2nlchild/socialstart1', get_string('options','theme_mb2nl'));
$temp->add($setting);
...
$setting = new admin_setting_configmb2start('theme_mb2nlchild/socialliststart', get_string('socillist','theme_mb2nl'));
$temp->add($setting);
...
$setting = new admin_setting_configmb2start('theme_mb2nlchild/shareiconstart', get_string('shareicons','theme_mb2nl'));
$temp->add($setting);
