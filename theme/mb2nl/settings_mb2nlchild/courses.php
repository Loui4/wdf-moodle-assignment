...
$temp->add($setting);
	...
	$name = 'theme_mb2nlchild/fsmodhome';
	...
	$name = 'theme_mb2nlchild/cpricedecimal';
	...
	$name = 'theme_mb2nlchild/cpricereverse';
	...
	$name = 'theme_mb2nlchild/coursespacer11';
	$setting = new admin_setting_configmb2spacer($name);
	$temp->add($setting);

	$name = 'theme_mb2nlchild/cficons';
...
$name = 'theme_mb2nlchild/onepagenav';
$title = get_string('onepagenav','theme_mb2nl');
$setting = new admin_setting_configcheckbox($name, $title, '', 0);
$temp->add($setting);

$name = 'theme_mb2nlchild/tabalt';
$title = get_string('tabalt','theme_mb2nl');
$setting = new admin_setting_configcheckbox($name, $title, '', 0);
$temp->add($setting);

$name = 'theme_mb2nlchild/enrolmentspacer1';
$setting = new admin_setting_configmb2spacer($name);
$temp->add($setting);
