...
class theme_mb2nl_external extends external_api
{
    ...
    //  *
    //  */
    // public static function course_completion( $courseid)
    // {
    ...
    //     $params = self::validate_parameters( self::course_completion_parameters(), array(
    //         'courseid' => $courseid
    //     ) );
    ...
    //     $results = array(
    //         'courseid' => theme_mb2nl_course_completion_percentage(3)
    //     );
