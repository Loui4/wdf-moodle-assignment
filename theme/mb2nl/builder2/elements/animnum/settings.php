...
$mb2_settings = array(
	...
	'attr' => array(
		...
		'group_animnum_start_3' => array('type'=>'group_start', 'section' => 'style', 'title'=> get_string('box', 'local_mb2builder')), // ============ GROUP START ============ //
		...
		'group_animnum_end_3' => array('type'=>'group_end', 'section' => 'style'), // ============ GROUP END ============ //
		
		'group_animnum_start_1' => array('type'=>'group_start', 'section' => 'style', 'title'=> get_string('number', 'local_mb2builder')), // ============ GROUP START ============ //
		'size_number'=>array(
			'type'=>'range',
			'min' => 1,
			'max' => 10,
		...
		'group_animnum_end_1' => array('type'=>'group_end', 'section' => 'style'), // ============ GROUP END ============ //
		'group_animnum_start_2' => array('type'=>'group_start', 'section' => 'style', 'title'=> get_string('title', 'local_mb2builder')), // ============ GROUP START ============ //
		'size_title'=>array(
			'type'=>'range',
			'min' => 1,
			'max' => 10,
		...
		'group_animnum_end_2' => array('type'=>'group_end', 'section' => 'style'), // ============ GROUP END ============ //
		
		
		'group_animnum_start_0' => array('type'=>'group_start', 'section' => 'style', 'title'=> get_string('subtitle', 'local_mb2builder')), // ============ GROUP START ============ //
		...
		'group_animnum_end_0' => array('type'=>'group_end', 'section' => 'style'), // ============ GROUP END ============ //
		...
		'runbutton'=>array(
			'type'=>'html',
			'section' => 'general',
			'html'=> '<a href="#" class="mb2-pb-btn sizesm typesuccess fw1 mb2-pb-animnum-run" style="margin-top:18px;">'  . get_string( 'runanimation', 'local_mb2builder' ) . '</a>'
		),
