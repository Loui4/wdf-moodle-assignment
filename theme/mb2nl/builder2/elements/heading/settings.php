...
$mb2_settings = array(
	...
	'attr' => array(
		'btext'=>array(
			'type'=>'text',
			'section' => 'general',
			'title'=> get_string('btext', 'local_mb2builder'),
			'action' => 'text',
			'selector' => '.btext'
		),
		'content'=>array(
		...
		'atext'=>array(
			'type'=>'text',
			'section' => 'general',
			'title'=> get_string('atext', 'local_mb2builder'),
			'action' => 'text',
			'selector' => '.atext'
		),
		'nline' => array(
			'type' => 'yesno',
			'section' => 'general',
			'title'=> get_string('nline', 'local_mb2builder'),
			'options' => array(
		...
		'linktext'=>array(
			...
			'title'=> get_string('text', 'local_mb2builder'),
			'action' => 'text',
			'selector' => '.heading-more-text',
			'default' => get_string( 'viewall', 'local_mb2builder' )
		),		
		'size'=>array(
			'type' => 'range',
			'section' => 'typo',
		...
		'bfwcls'=>array(
			'type' => 'buttons',
			'section' => 'typo',
			'title'=> get_string('bfwcls', 'local_mb2builder'),
			'options' => array(
				'global' => get_string('global', 'local_mb2builder'),
				'light' => get_string('fwlight', 'local_mb2builder'),
				'normal' => get_string('normal', 'local_mb2builder'),
		...
		'afwcls'=>array(
			'type' => 'buttons',
			'section' => 'typo',
			'title'=> get_string('afwcls', 'local_mb2builder'),
			'options' => array(
				'global' => get_string('global', 'local_mb2builder'),
				'light' => get_string('fwlight', 'local_mb2builder'),
				'normal' => get_string('normal', 'local_mb2builder'),
		...
		'tcshadow'=>array(
			...
			'action' => 'color',
			'style_properity' => '--mb2-pb-heading-tcshadow',
			'selector' => '.heading'
		),
		...
		'thshadow'=>array(
			...
			'selector' => '.heading',
			'changemode' => 'input',
			'style_properity' => '--mb2-pb-heading-thshadow'
		),
		'tvshadow'=>array(
			'type'=>'range',
			'section' => 'typo',
			...
			'selector' => '.heading',
			'changemode' => 'input',
			'style_properity' => '--mb2-pb-heading-tvshadow'
		),
		'tbshadow'=>array(
			'type'=>'range',
			'section' => 'typo',
			...
			'selector' => '.heading',
			'changemode' => 'input',
			'style_properity' => '--mb2-pb-heading-tbshadow'
		),	
		'typed' => array(
			'type' => 'yesno',
			'section' => 'typed',
		...
		'refreshtype'=>array(
			...
			'showon' => 'typed:1',
			'section' => 'typed',
			'html'=> '<button class="mb2-pb-btn typesuccess fw1 mb2-pb-type-refresh" style="margin-top:18px;">' .
		...
		'color' => array(
			...
			'action' => 'color',
			'selector' => '.headingtext,.heading-more',
			'style_properity' => 'color'
		),
		'bcolor' => array(
			'type' => 'color',
			'section' => 'style',
			'title'=> get_string('bcolor', 'local_mb2builder'),
			'action' => 'color',
			'selector' => '.btext',
			'style_properity' => 'color'
		),
		'acolor' => array(
			'type' => 'color',
			'section' => 'style',
			'title'=> get_string('acolor', 'local_mb2builder'),
			'action' => 'color',
			'selector' => '.atext,.heading-more i',
			'style_properity' => 'color'
		),
		'width'=>array(
			'type'=>'range',
