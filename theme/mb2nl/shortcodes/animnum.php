...
function mb2_shortcode_animnum_item ($atts, $content = null){
	...
	{
		$output .= '<div class="pbanimnum-icon" style="' . $color_icon_style . '"><i class="' . $con_pref . $icon . '"></i></div>';
	}

	$output .= '<div class="pbanimnum-number' . $ncls . '"' . $number_style . ' aria-label="' . $number . '">0</div>';
