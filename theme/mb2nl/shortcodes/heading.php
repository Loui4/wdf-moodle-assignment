...
function mb2_shortcode_heading ( $atts, $content = null ){
	...
	$style .= '--mb2-pb-heading-thshadow:' . $thshadow . 'em;';
	$style .= '--mb2-pb-heading-tvshadow:' . $tvshadow . 'em;';
	$style .= '--mb2-pb-heading-tbshadow:' . $tbshadow . 'px;';
	$style .= $tcshadow ? '--mb2-pb-heading-tcshadow:' . $tcshadow . ';' : '--mb2-pb-heading-tcshadow:transparent;';
	$style .= '"';
	...
	$output .= $link ? '<a href="' . $linkurl . '"' . $target . ' class="heading-more"' . $textstyle . '>' . format_text( $linktext, FORMAT_HTML ). '<i class="fa fa-arrow-right"' . $astyle . '></i></a>' : '';
	$output .= '</' . $tag . '>';
