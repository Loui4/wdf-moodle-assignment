...
$setting = new admin_setting_configmb2start('theme_mb2nl/starttopmenu', get_string('topmenu','theme_mb2nl'));
$temp->add($setting);
...
$setting = new admin_setting_configmb2end('theme_mb2nl/endtopmenu');
$temp->add($setting);
