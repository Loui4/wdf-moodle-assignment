...
function theme_mb2nl_shortcodes_swiper_nav($id)
{
	...
	$output .= '<button type="button" class="swiper-button-nav swiper-button-prev swiper-prevjs_' . $id . ' themereset" aria-label="' . $prevtext . '"></button>';
	$output .= '<button type="button" class="swiper-button-nav swiper-button-next swiper-nextjs_' . $id . ' themereset" aria-label="' . $nexttext . '"></button>';
	$output .= '</div>';
...
function theme_mb2nl_shortcodes_swiper_descnav($id, $btn)
{
	...
	$link_target = $btn['link_target'] ? ' target="_blank"' : '';

	$output .= '<div class="slide-contentnav' . $btn['cls'] . '">';
	$output .= '<button type="button" class="slide-contentnav-prev themereset swiper-prevjs_' . $id . '" aria-label="' . $prevtext . '"></button>';
	$output .= $btn['btnlink'] ? '<a href="' . $btn['btnlink'] . '" class="slide-contentnav-link"' . $link_target . '><span class="btn-intext">' . $btn['btntext'] . '</span><i class="fa fa-link"></i></a>' : '';
	$output .= '<button type="button" class="slide-contentnav-next themereset swiper-nextjs_' . $id . '" aria-label="' . $nexttext . '"></button>';
